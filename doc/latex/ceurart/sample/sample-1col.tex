...
%% TEMPORARY: To count the number of characters per page
\usepackage{lipsum}

%% Setting of tolerance to 9999
% \sloppy
...
%%
%% These commands are for the conference information
\ceurConference[Woodstock'20]{Woodstock'20: Symposium on Neural Gaze
  Detection}{June 03--05, 2020}{Woodstock, NY}
...
\IfFileExists{elsarticle-num-names.bst}{%
  \bibliographystyle{elsarticle-num-names}
}{
